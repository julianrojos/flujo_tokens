...
CREATE INDEX idx_tokens_ds_id ON tokens(ds_id);
CREATE INDEX idx_tokens_ds_id_id ON tokens(ds_id, id);
...
CREATE TABLE ai_jobs (
  ...
  output_json     JSONB,
  usage_json      JSONB,
  editorial_patch_json JSONB,
  validation_report_json JSONB,
  can_publish      BOOLEAN,
  pipeline_severity TEXT,
  pipeline_score   DOUBLE PRECISION,
  pipeline_stage   TEXT,
  error           TEXT,
  error_code      TEXT,
  retryable       BOOLEAN,
