/**
 * File Route Service Tests
 *
 * Tests for file route utilities.
 */
...
} from './file-route-service.js';

describe('file-route-service', () => {
  describe('resolveRequestedRepoPath()', () => {
    it('maps invalid path to API error', () => {
  ...
  describe('readFileContentPayload()', () => {
    it('maps read errors to API payloads', async () => {
  ...
  describe('resolveSnippetTargetLine()', () => {
    it('supports line and query modes', () => {
  ...
  describe('buildNotFoundFileError()', () => {
    it('maps message and context', () => {
