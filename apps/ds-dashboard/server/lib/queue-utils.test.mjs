...
test("queue-utils: identifies final statuses", () => {
...
test("queue-utils: queueJobSnapshot keeps stable shape", () => {
  const job = {
    id: "job_1",
    label: "npm run test",
...
test("queue-utils: queueJobAcceptedPayload includes status and stream urls", () => {
...
test("queue-utils: listQueueJobEvents applies since and limit", () => {
  const job = {
...
test("queue-utils: toQueueSummaryFromPayload prioritizes message fields", () => {
...
test("queue-utils: toQueueTerminalEvent normalizes missing result", () => {
