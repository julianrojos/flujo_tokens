...
describe("new-system import success summary", () => {
  ...
  it("falls back to targets length and tokens_written when totals are missing", () => {
    const summary = buildImportSuccessSummary({
      targets: [
        { slug: "one", node_id: "1", doc_path: "design-systems/sys-01/docs/components/one.md" },
        { slug: "two", node_id: "2", doc_path: "design-systems/sys-01/docs/components/two.md" },
        { slug: "three", node_id: "3", doc_path: "design-systems/sys-01/docs/components/three.md" },
      ],
      captured: [{ slug: "one", node_id: "1", doc_path: "design-systems/sys-01/docs/components/one.md" }],
      tokens_bootstrap: {
        attempted: true,
        files_written: 1,
