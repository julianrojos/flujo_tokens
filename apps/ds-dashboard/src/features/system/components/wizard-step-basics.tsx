/**
 * Wizard Step Basics - form for system name, Figma URL, token, options.
 */
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <label htmlFor="app-name" className="text-sm font-medium">App name (optional)</label>
          <Input
            id="app-name"
            value={form.appName}
            onChange={(e) => actions.onFieldChange("appName", e.target.value)}
            placeholder="e.g., acme-ds"
          />
        </div>
