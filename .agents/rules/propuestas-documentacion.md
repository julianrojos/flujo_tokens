...
**Falta actual:** No hay reglas claras sobre cómo documentar los estados transitivos (hover, active, focus, disabled) ni curvas de animación/duración (Motion).
...
## 6. Regla: Versionado y Registro de Cambios a nivel Componente
...
## 7. Regla: Principios de Localización Extensivos (Internacionalización Activa)

**Falta actual:** Falta dictar cómo manejar componentes donde el ancho del texto es crítico (botones o badges) bajo idiomas verbosos (ej. Alemán).
...
## 8. Regla: Guiones de Onboarding por Perfil (Role-based Onboarding)
...
## 9. Regla: Performance y Core Web Vitals en la Documentación
