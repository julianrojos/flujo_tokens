...
- Design systems SQLite available and at least one system configured (`apps/ds-dashboard/server/db/ds-dashboard.db` by default, override with `DS_DASHBOARD_DB_PATH`)
