/**
 * Figma Component Discovery Tests
 *
...
describe('figma-component-discovery', () => {
  describe('classifyTargetKind() and isKindAllowed()', () => {
    it('classifies and filters target kinds', () => {
  ...
  describe('extractSingleNodeCandidate()', () => {
    it('extracts single node candidate with normalized kind', () => {
  ...
  describe('resolveSpecExhibitNodeIds()', () => {
    it('resolves exhibit node ids from specs canvas frame', () => {
