...
} from './capture-spec-markdown-renderer.js';
import type { SpecAnatomyItem, SpecProperty as SpecPropertyType, SpecLayoutItem } from '../types/spec.js';
import type { SpecProperty as RendererSpecProperty, SpecLayoutRow } from './capture-spec-markdown-renderer.js';
...
function toRendererAnatomyItems(
  ...
  return anatomy.map((item, index) => ({
    ...
    fill: item.fill,
    fill_alias_chain: item.fill_alias_chain,
    fill_resolved: item.fill_resolved,
    stroke: item.stroke,
