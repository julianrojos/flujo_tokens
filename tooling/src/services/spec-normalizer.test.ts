 ...
 *
 * Tests for spec normalization functions.
 */
...
describe('spec-normalizer', () => {
  describe('mergeWithTemplate()', () => {
    it('preserves template defaults and generated overrides', () => {
      const template = {
        name: 'TBD',
        figma: {
          file: 'TBD',
  ...
  describe('normalizeSpecOrder()', () => {
    it('applies canonical top-level and figma key order', () => {
      const input = {
        token_mapping: {},
        summary: 'TBD',
        figma: {
    ...
    it('sorts properties by ordering group and canonical field order', () => {
      const input = {
        properties: [
          {
            required: true,
  ...
  describe('countTbdValues()', () => {
    it('counts TBDs accurately', () => {
      const input = {
        name: 'TBD',
        status: 'draft',
        figma: {
  ...
  describe('normalizeSpec()', () => {
    it('orchestrates merge, metadata, and order', () => {
