...
/**
 * Sort Spec - Wrapper Script
 *
 * Compatibility wrapper for the TypeScript runner.
 *
 * @deprecated Use `tsx tooling/src/runners/sort-spec-runner.ts` directly
 */
...
const runnerPath = path.join(__dirname, '../src/runners/sort-spec-runner.ts');
